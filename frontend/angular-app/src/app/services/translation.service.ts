...
export class TranslationService {
  private readonly translations: Record<LanguageCode, Record<string, string>> = {
    ...
    es: {
      ...
      'search.subtitle': 'Código actual',
      'search.placeholder': 'Ingresa el código del libro...',
      'search.button': 'Buscar',
      'search.codeLabel': 'Código',
      'search.codeFallback': 'N/D',
      'search.noPrefix': 'Sin prefijo',
      'gallery.title': 'Ubicación del libro',
      'gallery.floor': 'Mapa del piso',
      'gallery.section': 'Vista de sección',
