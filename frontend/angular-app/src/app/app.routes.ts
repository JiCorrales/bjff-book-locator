...
export const routes: Routes = [
  ...
  { path: 'admin', component: AdminPage, canActivate: [authGuard], data: { roles: ['admin', 'assistant'] },
    children: [
      ...
      { path: 'ranges-config', component: AdminRangesConfigComponent, canActivate: [authGuard], data: { roles: ['admin'] } },
      { path: 'users', component: AdminUsersComponent, canActivate: [authGuard], data: { roles: ['admin'] } },
